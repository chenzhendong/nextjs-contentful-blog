        ...
        <div className="box">
            <div>
                <div className="subtitle is-6">
                    ...
                    <span className="category-style">{ (post.fields.tags[0] as string).replaceAll("|"," -> ")}</span>
                </div>
            ...
            <div className="foot">
                <Link as={`/blog/${post.fields.slug}`} href="/blog/[slug]">
                    <span className="button is-small is-rounded is-info is-outlined">Read More</span>
                </Link>
            </div>
        </div>
    );
